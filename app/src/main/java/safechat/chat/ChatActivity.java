...
/**
 * Created by shankar on 3/25/2015.
 */
public class ChatActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        send_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                System.out.println("SetContent&&&&&" + chat_msg.getText().toString());
    ...
    private class Send extends AsyncTask<String, String, JSONObject> {
        ...
        protected JSONObject doInBackground(String... args) {
            ...
            String message=chat_msg.getText().toString();
            AsymmetricKeyGeneration asymmetricKeyGeneration= new AsymmetricKeyGeneration(1024);
            BigInteger plaintext = new BigInteger(message.getBytes());
            BigInteger ciphertext = asymmetricKeyGeneration.encrypt(plaintext);
            ...
            params.add((new BasicNameValuePair("msg",ciphertext.toString())));
            JSONObject jObj = json.getJSONFromUrl("http://192.168.56.1:8080/send",params);
            return jObj;
